...
public class ClassRosterServiceLayer implements IClassRosterServiceLayer {

    private IClassRosterDao dao;
    private IClassRosterAuditDao auditDao;

    public ClassRosterServiceLayer(IClassRosterDao dao, IClassRosterAuditDao auditDao) {
        this.dao = dao;
